...
file_name = './2ndcir2014X1_clean.csv'
...
def google_case_text_scraper(cite_file, sleep_time=30, dbug=0):
    ...
    # DO NOT FORGET TO CHANGE THE PATH!!!
    df.to_csv('./2ndcir2014X1_scraped{}.csv'.format(raw_len),encoding='utf-8',index=False)

    return 'Job Done'

google_case_text_scraper(file_name, sleep_time=30, dbug=1)
